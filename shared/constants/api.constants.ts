...
export const API_ENDPOINTS = {
  ...
  TIMETABLE: {
    TIMETABLES: {
      ...
      GET_BY_ID: (id: string) => `/api/timetable/timetables/${id}`,
      CREATE: '/api/timetable/timetables',
      UPDATE: (id: string) => `/api/timetable/timetables/${id}`,
      DELETE: (id: string) => `/api/timetable/timetables/${id}`,
      SUMMARY: (id: string) => `/api/timetable/timetables/${id}/summary`,
    },
    ITEMS: {
      GET_BY_TIMETABLE: (timetableId: string) => `/api/timetable/timetables/${timetableId}/items`,
      GET_BY_ID: (id: string) => `/api/timetable/timetable-items/${id}`,
      CREATE: '/api/timetable/timetable-items',
      UPDATE: (id: string) => `/api/timetable/timetable-items/${id}`,
      DELETE: (id: string) => `/api/timetable/timetable-items/${id}`,
    },
    TIME_SLOTS: {
    ...
    STUDENTS: {
      GET_ITEMS: (studentId: string) => `/api/timetable/students/${studentId}/items`,
      ENSURE_TIMETABLE: (studentId: string) => `/api/timetable/students/${studentId}/timetable`,
    },
    INIT: {
  ...
  ATTENDANCE: {
    ...
    GET_RECORD_BY_ID: (id: string) => `/api/attendance/records/${id}`,
    // POST /api/attendance/records - 출석 기록 생성
    CREATE_RECORD: '/api/attendance/records',
    // PUT /api/attendance/records/:id - 출석 기록 수정
    UPDATE_RECORD: (id: string) => `/api/attendance/records/${id}`,
    // DELETE /api/attendance/records/:id - 출석 기록 삭제
    DELETE_RECORD: (id: string) => `/api/attendance/records/${id}`,
    // GET /api/attendance/students/:studentId/records - 학생별 출석 기록
    GET_BY_STUDENT: (studentId: string) => `/api/attendance/students/${studentId}/records`,
  ...
  MONTHLY_REPORTS: {
    ...
    GET_BY_MONTH: (year: string, month: string) => `/api/monthly-reports/${year}/${month}`,
    // POST /api/monthly-reports - 월간 보고서 생성
    CREATE: '/api/monthly-reports',
    // PUT /api/monthly-reports/:year/:month - 월간 보고서 수정
    UPDATE: (year: string, month: string) => `/api/monthly-reports/${year}/${month}`
  },
