...
export const API_ENDPOINTS = {
  ...
  STUDENT_TIMETABLES: {
    ...
    GET_BY_STUDENT_AND_VERSION: (studentId: string, versionId: string) => `/api/student-timetables/student/${studentId}/version/${versionId}`,
    ...
    ADD_CLASS_BY_VERSION: (studentId: string, versionId: string) => `/api/student-timetables/student/${studentId}/version/${versionId}/add-class`,
    ...
    REMOVE_CLASS_BY_VERSION: (studentId: string, versionId: string) => `/api/student-timetables/student/${studentId}/version/${versionId}/remove-class`
  },
  ...
  TIMETABLE_VERSIONS: {
    ...
    COPY: (sourceVersionId: string) => `/api/timetable-versions/${sourceVersionId}/copy`,
    ...
    MIGRATE: (versionId: string) => `/api/timetable-versions/migration/${versionId}`
  },
