...
export const API_ENDPOINTS = {
    ...
    STUDENTS: {
        ...
        // api.ts에서 사용하는 추가 속성
        UPDATE_ATTENDANCE: (studentId) => `/api/attendance/student/${studentId}`, // ATTENDANCE 경로 사용
        // 학생 계층적 삭제 API
        // GET /api/students/:id/dependencies - 학생 의존성 확인
        GET_DEPENDENCIES: (id) => `/api/students/${id}/dependencies`,
        // DELETE /api/students/:id/hierarchical - 학생 계층적 삭제
        DELETE_HIERARCHICALLY: (id) => `/api/students/${id}/hierarchical`
    },
    // 부모 관리 API
    PARENTS: {
    ...
    ATTENDANCE: {
        ...
        GET_BY_ID: (id) => `/api/attendance/${id}`,
        ...
        GET_BY_STUDENT: (studentId) => `/api/attendance/student/${studentId}`,
        ...
        GET_STUDENT_STATISTICS: (studentId) => `/api/attendance/statistics/student/${studentId}`,
        // GET /api/attendance/summary/daily/:date - 일별 출석 현황 요약
        GET_DAILY_SUMMARY: (date) => `/api/attendance/summary/daily/${date}`,
        // GET /api/attendance/statistics/monthly/:year/:month - 월별 출석 통계
        GET_MONTHLY_STATISTICS: (year, month) => `/api/attendance/statistics/monthly/${year}/${month}`,
        ...
        GET_RECORD_BY_ID: (id) => `/api/attendance/${id}`, // GET_BY_ID와 동일
        CREATE_RECORD: '/api/attendance', // CREATE와 동일
        UPDATE_RECORD: (id) => `/api/attendance/${id}`, // UPDATE와 동일
        DELETE_RECORD: (id) => `/api/attendance/${id}`, // DELETE와 동일
    ...
    CLASS_SECTIONS: {
        ...
        GET_BY_ID: (id) => `/api/class-sections/${id}`,
        ...
        UPDATE: (id) => `/api/class-sections/${id}`,
        // DELETE /api/class-sections/:id - 수업 삭제
        DELETE: (id) => `/api/class-sections/${id}`,
        // GET /api/class-sections/search - 수업 검색
        SEARCH: '/api/class-sections/search',
        // GET /api/class-sections/teacher/:teacherId - 교사별 수업
        GET_BY_TEACHER: (teacherId) => `/api/class-sections/teacher/${teacherId}`,
        // GET /api/class-sections/course/:courseId - 강의별 수업
        GET_BY_COURSE: (courseId) => `/api/class-sections/course/${courseId}`,
        // GET /api/class-sections/classroom/:classroomId - 교실별 수업
        GET_BY_CLASSROOM: (classroomId) => `/api/class-sections/classroom/${classroomId}`,
        // GET /api/class-sections/stats - 수업 통계
        GET_STATS: '/api/class-sections/stats',
        // GET /api/class-sections/:id/dependencies - 수업 의존성 확인
        GET_DEPENDENCIES: (id) => `/api/class-sections/${id}/dependencies`,
        // DELETE /api/class-sections/:id/hierarchical - 수업 계층적 삭제
        DELETE_HIERARCHICALLY: (id) => `/api/class-sections/${id}/hierarchical`,
        // POST /api/class-sections/:id/students - 수업에 학생 추가
        ADD_STUDENT: (classSectionId, studentId) => `/api/class-sections/${classSectionId}/students/${studentId}`,
        // DELETE /api/class-sections/:id/students/:studentId - 수업에서 학생 제거
        REMOVE_STUDENT: (classSectionId, studentId) => `/api/class-sections/${classSectionId}/students/${studentId}`,
        // GET /api/class-sections/:id/students - 수업에 등록된 학생 목록 조회
        GET_ENROLLED_STUDENTS: (classSectionId) => `/api/class-sections/${classSectionId}/students`
    },
    // 학생 시간표 관리 API
    STUDENT_TIMETABLES: {
        ...
        GET_BY_ID: (id) => `/api/student-timetables/${id}`,
    ...
    TEACHERS: {
        ...
        GET_DEPENDENCIES: (id) => `/api/teachers/${id}/dependencies`,
        // DELETE /api/teachers/:id/hierarchical - 교사 계층적 삭제
        DELETE_HIERARCHICALLY: (id) => `/api/teachers/${id}/hierarchical`
    },
    // 교실 관리 API
    CLASSROOMS: {
        ...
        GET_DEPENDENCIES: (id) => `/api/classrooms/${id}/dependencies`,
        // DELETE /api/classrooms/:id/hierarchical - 강의실 계층적 삭제
        DELETE_HIERARCHICALLY: (id) => `/api/classrooms/${id}/hierarchical`
    },
    // 시간대 관리 API
    TIME_SLOTS: {
    ...
    SEATS: {
        ...
        GET_BY_ID: (id) => `/api/seats/${id}`,
        // POST /api/seats - 좌석 생성
        CREATE: '/api/seats',
        // PUT /api/seats/:id - 좌석 수정
        UPDATE: (id) => `/api/seats/${id}`,
        // DELETE /api/seats/:id - 좌석 삭제
        DELETE: (id) => `/api/seats/${id}`,
        ...
        GET_BY_STATUS: (status) => `/api/seats/status/${status}`,
        ...
        UPDATE_STATUS: (id) => `/api/seats/${id}/status`,
        // PATCH /api/seats/:id/active - 좌석 활성화/비활성화
        TOGGLE_ACTIVE: (id) => `/api/seats/${id}/active`,
        ...
        // api.ts에서 사용하는 추가 속성
        GET_BY_STUDENT: (studentId) => `/api/seat-assignments/student/${studentId}` // SEAT_ASSIGNMENTS 경로 사용
    },
    // 좌석 배정 관리 API
    SEAT_ASSIGNMENTS: {
        ...
        GET_BY_SEAT: (seatId) => `/api/seat-assignments/seat/${seatId}`,
        // GET /api/seat-assignments/student/:studentId - 특정 학생의 좌석 배정 조회
        GET_BY_STUDENT: (studentId) => `/api/seat-assignments/student/${studentId}`,
        // GET /api/seat-assignments/date/:date - 특정 날짜의 좌석 배정 조회
        GET_BY_DATE: (date) => `/api/seat-assignments/date/${date}`,
        ...
        UPDATE_STATUS: (id) => `/api/seat-assignments/${id}/status`,
        // POST /api/seat-assignments/:id/release - 좌석 배정 해제
        RELEASE: (id) => `/api/seat-assignments/${id}/release`,
        // GET /api/seat-assignments/student/:studentId/current - 학생의 현재 활성 좌석 배정 조회
        GET_CURRENT_BY_STUDENT: (studentId) => `/api/seat-assignments/student/${studentId}/current`,
        // GET /api/seat-assignments/seat/:seatId/current - 좌석의 현재 활성 배정 조회
        GET_CURRENT_BY_SEAT: (seatId) => `/api/seat-assignments/seat/${seatId}/current`,
        // GET /api/seat-assignments/student/:studentId/history - 학생의 좌석 배정 기록 조회
        GET_HISTORY_BY_STUDENT: (studentId) => `/api/seat-assignments/student/${studentId}/history`,
        // GET /api/seat-assignments/seat/:seatId/history - 좌석의 배정 기록 조회
        GET_HISTORY_BY_SEAT: (seatId) => `/api/seat-assignments/seat/${seatId}/history`
    },
    // 테스트 데이터 초기화 API
    TEST_DATA: {
